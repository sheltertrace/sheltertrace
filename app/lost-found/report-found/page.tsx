  ...
  return (
    <div style={{ minHeight:"100vh", background:"#f0f7ff", fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth:720, margin:"0 auto", padding:"28px 16px 60px" }}>
        ...
        <p style={{ fontSize:14, color:"#64748b", marginBottom:16 }}>Thank you for helping a lost animal! Post your found pet report here.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={sect}>
            ...
            <F label="General Area / Cross Streets" req>
              <input style={inp} value={address} onChange={(e)=>setAddress(e.target.value)} placeholder="e.g. Near Oak St & Pine Ave, or In the area of Athens Hwy"/>
