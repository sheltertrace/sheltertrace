...
<style>
  * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
  ...
  <div style="margin-bottom:6px;">
    ${box(!!a.behavior_friendly, "Friendly / Approachable")}
    ${box(!!a.behavior_fearful_skittish, "Fearful / Skittish")}
    ${box(!!a.behavior_aggressive, "Aggressive")}
    ${box(!!a.behavior_feral_unhandleable, "Feral / Unhandleable")}
  </div>
